...
function requiredOption(options, name, code) {
...
function cleanOpenAiMessages(messages, { provider } = {}) {
...
function writeCodexExecHome(mcpServers, sessionDir, { sourceHome = defaultCodexAuthHome(), writeDurableTextFile = writeFileSync } = {}) {
...
function codexExecConfigToml(mcpServers) {
  const lines = [
    '# Generated by packages/nars-provider-runtime/src/canonical-protocol-adapters.mjs for nested Codex subprocesses.',
