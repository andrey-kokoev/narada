...
const replacements: any = [
  {
    file: 'tools/task-lifecycle/tests/Test-BatchOperationsAndIntentCleanup.ts',
    changes: [
  ...
  {
    file: 'tools/task-lifecycle/tests/Test-InboxBridge.ts',
    changes: [
  ...
  {
    file: 'tools/task-lifecycle/tests/Test-McpBridgePoll.ts',
    changes: [
  ...
  {
    file: 'tools/task-lifecycle/tests/Test-McpInspectAndEvidenceTools.ts',
    changes: [
  ...
  {
    file: 'tools/task-lifecycle/tests/Test-TaskCreateAndSpecSync.ts',
    changes: [
  ...
  {
    file: 'tools/task-lifecycle/tests/Test-TaskEvidenceCli.ts',
    changes: [
  ...
  {
    file: 'tools/task-lifecycle/tests/Test-TaskListNPlusOneFix.ts',
    changes: [
...
for (const { file, changes } of replacements) {
  let content: any = readFileSync(file, 'utf8');
