 ...
 */
export function writeFileUtf8(filePath: any, content: any) : any {
 ...
 */
export function writeJsonFile(filePath: any, data: any, space: any = 2) : any {
  const json: any = JSON.stringify(data, null, space);
 ...
 * @param {string} body
 */
export function writeMarkdownWithFrontmatter(filePath: any, frontmatter: any, body: any) : any {
  const yaml: any = Object.entries(frontmatter)
