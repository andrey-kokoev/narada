export const TASK_LIFECYCLE_ASSIGNMENT_TOOL_NAMES: any = Object.freeze([
...
export function createTaskLifecycleAssignmentHandlers({
  ...
  return {
    task_lifecycle_claim: async (args: any) : Promise<any> => {
    ...
    task_lifecycle_continue: async (args: any) : Promise<any> => {
      const taskNumber: any = numberField(args, 'task_number');
      const agentId: any = stringField(args, 'agent_id');
    ...
    task_lifecycle_unclaim: async (args: any) : Promise<any> => {
      const taskNumber: any = numberField(args, 'task_number');
      const agentId: any = stringField(args, 'agent_id');
