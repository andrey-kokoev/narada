export const TASK_LIFECYCLE_CREATE_RECURRING_TOOL_NAMES: any = Object.freeze([
...
export function createTaskLifecycleCreateRecurringHandlers(context: any) : any {
  const {
    store,
    siteRoot,
    jsonToolResult,
  ...
  async function dispatchCreateRecurringTool(canonicalName: any, args: any, dispatchContext: any = {}) : Promise<any> {
