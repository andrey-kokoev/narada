export const TASK_LIFECYCLE_ADMIN_TOOL_NAMES: any = Object.freeze([
...
export function createTaskLifecycleAdminHandlers({
  ...
  return {
    task_lifecycle_doctor: () : any => {
      const registeredTools: any = getRegisteredTools();
    ...
    task_lifecycle_restart: (args: any) : any => jsonToolResult(taskLifecycleRestart(args)),
  };
}
