...
import { agentInstructionChain, createCarrierRuntimeDependencies } from './runtime-dependencies.mjs';
...
test('server mode refreshes AGENTS authority prompt for resumed sessions', async () => {
  const root = mkdtempSync(join(tmpdir(), 'carrier-agents-resume-test-'));
