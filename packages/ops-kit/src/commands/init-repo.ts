...
export function initRepo(repoPath: string, options: InitRepoOptions = {}): InitRepoResult {
  ...
  const readmeLines = options.demo
    ...
    : [
        ...
        "narada setup",
        "",
        "# 4. Bind credential references without copying raw secrets into config",
        ...
        "# provide the referenced local secret material at runtime; direct .env copying is manual recovery",
        "",
