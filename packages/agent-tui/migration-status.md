...
- Layout, status, composer, transcript, and aggregate app view models, including disabled/refused/configured-not-implemented provider posture in status output.
