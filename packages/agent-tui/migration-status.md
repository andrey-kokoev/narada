...
- Layout, status, composer, transcript, and aggregate app view models, including disabled/refused/configured-not-implemented provider posture and disabled/refused/configured MCP posture in status output.
