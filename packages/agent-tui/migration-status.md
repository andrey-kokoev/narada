...
- Provider dispatch trait plus stable provider request payload contract, centralized adapter factory, stub, and scripted admitted adapters; real provider execution remains disabled outside explicit adapter admission.
