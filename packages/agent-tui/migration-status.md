...
- Provider dispatch trait plus carrier-validated, schema-marked provider request payloads, schema-marked provider output payload contracts, centralized adapter factory, stub, and scripted admitted adapters; real provider execution remains disabled outside explicit adapter admission.
