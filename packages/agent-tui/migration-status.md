...
- Layout, status, composer, transcript, and aggregate app view models, including disabled/refused/configured-not-implemented provider posture plus disabled/refused/configured MCP and terminal-rendering posture in status output.
