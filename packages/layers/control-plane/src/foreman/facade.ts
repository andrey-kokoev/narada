...
export class DefaultForemanFacade implements ForemanFacade {
  ...
  async resolveWorkItem(resolveReq: ResolveWorkItemRequest): Promise<ResolutionResult> {
    ...
    const evaluation: import("./types.js").EvaluationEnvelope = {
      ...
      outcome: evalRow.outcome as import("@narada-core/charters").CharterOutputEnvelope["outcome"],
      confidence: JSON.parse(evalRow.confidence_json) as import("@narada-core/charters").CharterOutputEnvelope["confidence"],
