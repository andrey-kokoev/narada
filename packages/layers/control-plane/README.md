...
`narada` compiles remote source deltas into locally materialized state and durable side-effect intents. It is not a sync client, cache, or email tool. It is a deterministic state compiler with these properties:
