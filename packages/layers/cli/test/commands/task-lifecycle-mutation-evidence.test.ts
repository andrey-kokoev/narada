...
import { validateMutationEvidenceRecord, type MutationEvidenceRecord } from '@narada-core/task-governance-core/mutation-evidence';
...
describe('task lifecycle mutation evidence', () => {
  ...
  it('records accepted stale governance freshness posture in mutation evidence', async () => {
    ...
    process.env.NARADA_STALE_DIST_SOURCE_PATHS = '@narada-core/task-governance-core:/repo/packages/task-governance/src/task-close-service.ts\n@narada-core/cli:/repo/packages/layers/cli/src/commands/task-close.ts';
    ...
    try {
      ...
      expect(evidence.replay_payload.governance_freshness).toMatchObject({
        ...
        source_paths: [
          '@narada-core/task-governance-core:/repo/packages/task-governance/src/task-close-service.ts',
          '@narada-core/cli:/repo/packages/layers/cli/src/commands/task-close.ts',
        ],
      });
    } finally {
