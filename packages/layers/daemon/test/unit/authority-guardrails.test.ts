...
import { createObservationRoutes } from "../../src/observation/observation-routes.js";
import { createOperatorActionRoutes } from "../../src/observation/operator-action-routes.js";
import { PERMITTED_OPERATOR_ACTIONS } from "../../src/observation/operator-actions.js";

const __filename = fileURLToPath(import.meta.url);
const __dirname = dirname(__filename);

const projectRoot = resolve(__dirname, "..", "..", "..", "..", "..");
const daemonSrc = resolve(projectRoot, "packages", "layers", "daemon", "src");
