# @narada-core/site-registry-contract

Canonical, browser-safe types and boundary parsers for the User Site registry.

The durable registry implementation remains owned by `@narada-core/windows-site`.
...
`@narada-core/site-config` remains a separate contract for Site awareness and
