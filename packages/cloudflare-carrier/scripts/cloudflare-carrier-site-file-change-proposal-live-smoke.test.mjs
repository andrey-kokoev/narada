...
} from './cloudflare-carrier-site-file-change-proposal-live-smoke.mjs';
...
test('formatSiteFileChangeProposalLiveSmokeText emits downstream reads', () => {
  ...
  assert.match(text, /Proposal Review: pnpm --filter @narada2\/cloudflare-carrier product:site-file-change-proposal:text/);
