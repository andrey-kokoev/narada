...
export function parseOperatorSessionStatusArgs(argv: any= [], env: any= process.env) {
  const args = [...argv];
...
export async function readOperatorSessionStatus({ workerUrl, auth }: any, fetchImpl: any= fetch) {
...
export function formatOperatorSessionStatus(result: any, format: any= 'json') {
