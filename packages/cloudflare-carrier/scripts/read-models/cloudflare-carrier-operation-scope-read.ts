...
export function parseOperationScopeReadArgs(argv: any= [], env: any= process.env) {
  return parseProductReadArgs(['--operation', 'operation.read', ...argv], env);
}

export async function readOperationScope(config: any, fetchImpl: any= fetch) {
...
export function summarizeOperationScope(body: any= {}) {
...
export function formatOperationScopeReadText(result: any) {
