...
export function parseTaskLifecycleReportLiveSmokeArgs(argv = [], env = process.env, { loadEnv = true } = {}) {
  const args = [...argv];
...
export function formatTaskLifecycleReportLiveSmokeText(result) {
  const lines = [
...
export async function runTaskLifecycleReportLiveSmoke(config, { fetchImpl = fetch } = {}) {
