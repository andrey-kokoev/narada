...
export function parseTaskLifecycleProjectionWriteLiveSmokeArgs(argv = [], env = process.env, { loadEnv = true } = {}) {
  const args = [...argv];
...
export function formatTaskLifecycleProjectionWriteLiveSmokeText(result) {
  const lines = [
...
export async function runTaskLifecycleProjectionWriteLiveSmoke(config, { fetchImpl = fetch } = {}) {
