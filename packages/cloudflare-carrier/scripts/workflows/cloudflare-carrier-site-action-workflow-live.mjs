...
const siteContinuityPublishScript = resolve(scriptDir, '../commands/cloudflare-carrier-site-continuity-publish.mjs');
...
const siteScopeReadScript = resolve(scriptDir, '../read-models/cloudflare-carrier-site-scope-read.mjs');
const siteMembershipPutScript = resolve(scriptDir, '../commands/cloudflare-carrier-site-membership-put.mjs');
const authorityTransferReadScript = resolve(scriptDir, '../read-models/cloudflare-carrier-authority-transfer-read.mjs');
