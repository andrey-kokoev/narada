...
export function parseRepositoryPublicationReadinessLiveSmokeArgs(argv: any= [], env: any= process.env, { loadEnv = true }: any= {}) {
  const args = [...argv];
...
export function formatRepositoryPublicationReadinessLiveSmokeText(result: any) {
...
export async function runRepositoryPublicationReadinessLiveSmoke(config: any, fetchImpl: any= fetch) {
