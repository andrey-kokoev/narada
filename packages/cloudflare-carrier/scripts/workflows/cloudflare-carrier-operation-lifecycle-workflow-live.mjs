...
const operationCreateScript = resolve(scriptDir, '../commands/cloudflare-carrier-operation-create.mjs');
const operationStatusPutScript = resolve(scriptDir, '../commands/cloudflare-carrier-operation-status-put.mjs');
