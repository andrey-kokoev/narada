...
const taskCreateScript = resolve(scriptDir, '../commands/cloudflare-carrier-task-lifecycle-create.mjs');
const taskClaimScript = resolve(scriptDir, '../commands/cloudflare-carrier-task-lifecycle-claim.mjs');
const taskReportScript = resolve(scriptDir, '../commands/cloudflare-carrier-task-lifecycle-report.mjs');
const taskFinishScript = resolve(scriptDir, '../commands/cloudflare-carrier-task-lifecycle-finish.mjs');
const taskReadScript = resolve(scriptDir, '../read-models/cloudflare-carrier-task-lifecycle-read.mjs');
