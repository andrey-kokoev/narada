...
export function buildProviderLivenessSchedulerPlan({
  ...
  refreshEntrypoint = 'packages/cloudflare-carrier/scripts/workflows/cloudflare-carrier-provider-liveness-refresh.mjs',
  scheduledTaskEntrypoint = 'packages/cloudflare-carrier/scripts/workflows/cloudflare-carrier-provider-liveness-scheduled-task.mjs',
  localRoot = null,
