...
export function parseTaskLifecycleRoleResolutionWriteLiveSmokeArgs(argv = [], env = process.env, { loadEnv = true } = {}) {
  const args = [...argv];
...
export function formatTaskLifecycleRoleResolutionWriteLiveSmokeText(result) {
  const lines = [
...
export async function runTaskLifecycleRoleResolutionWriteLiveSmoke(config, { fetchImpl = fetch } = {}) {
