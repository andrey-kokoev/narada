...
export function resolveAuth(args: any= [], env: any= process.env) {
...
export function authHeaders(auth: any) {
...
export async function requestCarrierJson(config: any, fetchImpl: any= fetch) {
...
export function parseJsonText(text: any) {
  try {
...
function sessionFileAuth(path: any, source: any) {
...
function normalizeOperatorSessionCookie(value: any) {
