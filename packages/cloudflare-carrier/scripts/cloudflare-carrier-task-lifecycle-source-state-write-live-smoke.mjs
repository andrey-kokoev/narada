...
export function parseTaskLifecycleSourceStateWriteLiveSmokeArgs(argv = [], env = process.env, { loadEnv = true } = {}) {
  const args = [...argv];
...
export function formatTaskLifecycleSourceStateWriteLiveSmokeText(result) {
  const lines = [
...
export async function runTaskLifecycleSourceStateWriteLiveSmoke(config, { fetchImpl = fetch } = {}) {
