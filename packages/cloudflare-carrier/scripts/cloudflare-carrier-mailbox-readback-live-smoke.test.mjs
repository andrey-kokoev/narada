...
test('formatMailboxReadbackLiveSmokeText emits downstream reads', () => {
  ...
  assert.match(text, /Draft Proposal Read: pnpm --filter @narada2\/cloudflare-carrier product:mailbox:draft-reply-proposal:text/);
    ...
    fetchImpl: async (_url, init) => {
      ...
      if (body.operation === 'operation.read') {
        return responseJson(200, {
          ...
          mailbox_send_accepted_records: [],
          mailbox_send_confirmations: [],
