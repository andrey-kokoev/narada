...
const missing = checks.filter((check: any) => !check.present).map((check: any) => check.name);
const errors = [];
...
function checkPresence(name: any, sourceEnv: any, value: any) {
...
function readSecretFile(secretFilePath: any) {
