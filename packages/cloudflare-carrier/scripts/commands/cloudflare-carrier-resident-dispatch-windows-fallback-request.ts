...
export function parseResidentDispatchWindowsFallbackRequestArgs(argv: any= [], env: any= process.env, now: any= () => Date.now()) {
  const args = [...argv];
...
export async function runResidentDispatchWindowsFallbackRequest(config: any, fetchImpl: any= fetch) {
...
export function createResidentDispatchWindowsFallbackRequest(config: any, fetchImpl: any= fetch) {
  return runResidentDispatchWindowsFallbackRequest({ ...config, operation: CREATE_OPERATION }, fetchImpl);
}

export function summarizeResidentDispatchWindowsFallbackRequest(operation: any, body: any= {}) {
...
export function formatResidentDispatchWindowsFallbackRequestText(result: any= {}) {
