...
export function classifyCloudflareOperationCommandState(input: any= {}) {
...
export function shouldPromoteOperationOperatorFocus(operation: any= null, next: any= {}) {
  const status = String(operation?.status ?? '').toLowerCase();
  if (!['monitor_operation', 'start_or_select_session'].includes(next?.action)) return false;
  return status !== 'closed';
}

export function classifyCloudflareAuthorityCommandState(input: any= {}) {
...
export function classifyCloudflareSessionCommandState(input: any= {}) {
...
export function classifyCloudflareTaskCommandState(input: any= {}) {
...
export function classifyCloudflareEvidenceCommandState(event: any= {}, options: any= {}) {
...
export function classifyCloudflareSiteCommandState(input: any= {}) {
...
export function classifyCloudflareMembershipCommandState(input: any= {}) {
