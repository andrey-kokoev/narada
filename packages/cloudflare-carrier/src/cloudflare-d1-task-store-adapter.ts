...
import { createCloudflarePersistenceRegistry } from './cloudflare-persistence-registry.ts';
...
function createD1SessionTaskStore(repository: any, context: any= {}) {
...
async function findTask(repository: any, siteId: any, taskIdOrNumber: any) {
