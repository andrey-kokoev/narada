const SITE_LIVE_CARRIER_STATE_SCHEMA: any = 'narada.site_live_carrier.lifecycle_state.v1';

const SITE_LIVE_CARRIER_STATES: any = Object.freeze([
  'requested',
  'planning',
  'planned',
  'applying',
...
const SITE_LIVE_CARRIER_TRANSITIONS: any = Object.freeze({
...
function assertSiteLiveCarrierState(state: any) : any{
...
function canTransitionSiteLiveCarrier(from: any, to: any) : any{
...
function createSiteLiveCarrierLifecycle(initialState: any = 'requested') : any{
...
function transitionSiteLiveCarrierLifecycle(lifecycle: any, nextState: any) : any{
...
function assertSiteLiveCarrierTransition(lifecycle: any, nextState: any) : any{
  if (!canTransitionSiteLiveCarrier(lifecycle.state, nextState)) {
    throw new Error(`invalid_site_live_carrier_transition: ${lifecycle.state}->${nextState}`);
  }
  return true;
