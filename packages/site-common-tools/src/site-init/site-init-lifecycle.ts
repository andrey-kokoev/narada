export const SITE_INIT_LIFECYCLE_SCHEMA: any = 'narada.site_init.lifecycle_state.v1';

export const SITE_INIT_LIFECYCLE_STATES: any = Object.freeze([
  'requested',
  'inspecting',
  'planned',
  'previewed',
...
export function createSiteInitLifecycle(initialState: any = 'requested') : any{
...
export function canTransitionSiteInitLifecycle(from: any, to: any) : any{
  assertState(from);
  assertState(to);
  return from === to || TRANSITIONS[from].includes(to);
}

export function transitionSiteInitLifecycle(lifecycle: any, nextState: any) : any{
