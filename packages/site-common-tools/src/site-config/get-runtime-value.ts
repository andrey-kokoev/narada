 ...
 */
export function loadSiteConfig(siteRoot: any) : any{
 ...
 */
export function getRuntimeValue(config: any, path: any) : any{
 ...
 * Returns undefined if the parameter is not found.
 */
export function getRuntimeParam(config: any, path: any) : any{
  if (!config || typeof config !== 'object') return undefined;
