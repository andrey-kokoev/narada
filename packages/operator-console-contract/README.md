...
Cloudflare-hosted. Route paths are constrained to same-origin,
workspace-relative paths; consumers reject external and protocol-relative
navigation targets at the contract boundary.
