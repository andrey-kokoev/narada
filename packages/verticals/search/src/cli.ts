 ...
 * narada-search CLI
 * 
 * Full-text search CLI for narada messages.
 */
...
function printHelp(): void {
  console.log(`
narada-search - Full-text search for mailbox messages

USAGE:
  narada-search <command> [options]
...
EXAMPLES:
  ...
  # Search for "meeting"
  narada-search search "meeting"

  # Search with filters
  narada-search search -q "project" -u --folder inbox

  # Boolean search
  narada-search search "urgent OR (meeting -cancelled)"
`);
}
