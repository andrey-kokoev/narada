...
if (args.help) {
  process.stdout.write([
    ...
    '',
    'Live mode:',
    '  pnpm --filter @narada2/cloudflare-nars-projection smoke:provider-capable-live -- --live --cloudflare-api-base-url <url> --principal-id <principal> --browser-token <fingerprint>',
    '',
