...
import { startSessionCoreRuntime, waitFor } from './nars-runtime-fixture.js';

test('Agent Web UI renders health emitted by the attached session-core runtime', async ({ page }: any) => {
