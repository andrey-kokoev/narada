...
<template>
  <div v-if="available" class="inbox-panel-shell">
    <button type="button" class="mcp-panel-trigger inbox-panel-trigger" :aria-expanded="open" aria-controls="inbox-panel" @click="open = !open">
