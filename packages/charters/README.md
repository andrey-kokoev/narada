...
- `@narada2/exchange-fs-sync`: deterministic kernel and mailbox vertical
- `@narada2/exchange-fs-sync-daemon`: long-running orchestration surface
- `@narada2/exchange-fs-sync-cli`: operator CLI
