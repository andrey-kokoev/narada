...
import { emitEnvelopeAdmitted, acknowledgeEnvelope, dismissEnvelope, exportDispositionLedger, readAdmissionLog, recordPromotion, resolveEnvelopeStatus } from '../inbox/admission-log.mjs';
...
function callTool(params, site, serverOptions) {
  ...
  const preflightArgs = canonicalName === 'inbox_submit_typed_envelope' && args.payload_ref
    ? resolveToolPayloadArgs({
