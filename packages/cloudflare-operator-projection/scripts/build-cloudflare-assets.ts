...
type AssetFile = { relativePath: string; content: Buffer };
...
async function readSourceArtifactManifest(assetRoot: string): Promise<AnyRecord> {
...
async function hashAssetTree(root: string): Promise<AnyRecord> {
...
async function collectFiles(root: string, current: string, files: AssetFile[]): Promise<void> {
