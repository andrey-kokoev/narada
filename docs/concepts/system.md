...
Here, `separation` is the opposite of **collapse**. Collapse means model judgment, permission, intent, execution, and confirmation are compressed until intelligence becomes unmediated consequence. Narada's control path keeps those functions separately owned:
