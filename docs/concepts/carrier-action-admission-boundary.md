...
This is an instance of the general Narada rule in [Names Identify; They Do Not Mean](./names-identify-do-not-mean.md): names are identifiers, not semantic classifiers. Carrier Action Admission applies that rule specifically to authority, effect, and admission posture.
