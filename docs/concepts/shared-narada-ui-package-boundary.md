...
@narada-core/ui owns renderer-neutral web presentation foundations:
...
@narada-core/ui-vue owns Vue-specific reusable primitives:
...
It consumes @narada-core/ui and @narada-core/ui-vue; it is not their implementation owner.
...
- @narada-core/ui has no dependency on Agent Web UI or MCP domain code.
- @narada-core/ui-vue depends on @narada-core/ui and Vue UI runtime dependencies.
- @narada-core/agent-web-ui depends on both shared UI packages.
- CLI Site Registry may consume @narada-core/ui styles but does not acquire a Vue runtime requirement.
...
| --- | --- | --- | --- |
| Standalone HTML or CLI page | @narada-core/ui | No | No |
| Vue web surface | @narada-core/ui | @narada-core/ui-vue | App-owned |
| Agent Web UI | @narada-core/ui | @narada-core/ui-vue | @narada-core/agent-web-ui |
