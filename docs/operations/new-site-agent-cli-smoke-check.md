# New Site Agent-CLI Smoke Check

Run these checks before declaring a Site aligned with packaged Narada agent-cli and MCP transport.
...
2. Confirm the preamble shows the packaged agent-cli.
