...
- Real launch acceptance owns narrow proof that the same projection attaches through the Narada CLI to a local NARS runtime. It does not replace comprehensive fixture-backed browser E2E, and fixture-backed E2E does not prove external provider quality.
