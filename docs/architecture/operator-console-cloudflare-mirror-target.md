...
Access service token or an exported CF_Authorization cookie:
    ...
    pnpm --filter @narada2/cloudflare-nars-projection smoke:operator-console-mirror-live -- --live --url https://<worker-host> --access-client-id <client-id> --access-client-secret-file <secret-file>
