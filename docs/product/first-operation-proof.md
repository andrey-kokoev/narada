...
For the full knowledge placement model, see [`docs/concepts/mailbox-knowledge-model.md`](../concepts/mailbox-knowledge-model.md).
...
- This proof does not cover generalized knowledge-base RAG. Knowledge source injection exists; the knowledge model is documented in [`docs/concepts/mailbox-knowledge-model.md`](../concepts/mailbox-knowledge-model.md).
