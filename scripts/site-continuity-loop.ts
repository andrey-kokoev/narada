...
} from '../packages/site-continuity/src/site-continuity.ts';
...
async function writeLoopPacketFile(registryPathValue: any, packetSiteId: any, packet: any) {
...
function parsePnpmJsonOutput(text: any, commandName: any) {
...
function createWindowsContinuityPacket(input: any) {
...
async function readCloudflareSite(readSiteId: any) {
...
async function pushCloudflareLoopReport(pushSiteId: any, report: any) {
...
async function pushCloudflarePacket(pushSiteId: any, packet: any) {
...
async function publishCloudflarePacket(publishSiteId: any) {
...
async function postCloudflare(body: any) {
...
function summarizeCloudflarePush(push: any) {
...
function summarizeCloudflarePublication(publication: any) {
...
function summarizeCloudflareReportPush(push: any) {
  return {
    status: push.status ?? 'ok',
...
function tokenFileSource(path: any) {
...
function resolveRegistryDbPath() {
  if (process.platform=== 'win32') {
    ...
    if (!localAppData) {
      fail('cannot_resolve_windows_registry_path');
      throw new Error('cannot_resolve_windows_registry_path');
    }
...
function boundedLimit(value: any) {
