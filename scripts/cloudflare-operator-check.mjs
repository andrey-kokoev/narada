...
assert.equal(operationPersistencePosture?.durable_boundaries.some((boundary) => boundary.key === 'repository_publication_evidence_store' && boundary.status === 'available'), true);
...
assert.equal(operationRecoveryPosture?.recovery_boundaries.some((boundary) => boundary.key === 'repository_publication_evidence_store' && boundary.status === 'recoverable'), true);
