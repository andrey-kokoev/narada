...
Update `.ai/do-not-open/tasks/20260419-209-promotion-operator-family.md` execution evidence if stale.
...
Check `.ai/do-not-open/tasks/20260419-208-selection-operator-family.md` and `.ai/do-not-open/tasks/20260419-210-inspection-operator-family-alignment.md` for stale claims caused by later code movement or verification policy changes.
...
```bash
rg "draft_ready.*submitted|approve_draft_for_send|retry_failed_work_items|PERMITTED_OPERATOR_ACTIONS" SEMANTICS.md .ai/do-not-open/tasks/20260419-208-selection-operator-family.md .ai/do-not-open/tasks/20260419-209-promotion-operator-family.md .ai/do-not-open/tasks/20260419-210-inspection-operator-family-alignment.md packages/layers/control-plane/src/operator-actions packages/layers/daemon/src/observation
pnpm verify
```
...
- `rg "draft_ready.*submitted" SEMANTICS.md .ai/do-not-open/tasks/20260419-209-promotion-operator-family.md` — no matches.
