...
Run a focused audit over `.ai/do-not-open` and report any existing terminal tasks with unchecked criteria.
...
- Audited `.ai/do-not-open/tasks/` and found 119 terminal tasks with violations. Tasks 469–473 in the current chapter are valid. Created follow-up Task 475 for corrective audit.
