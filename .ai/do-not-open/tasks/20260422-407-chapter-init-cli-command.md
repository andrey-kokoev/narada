...
2. Create files.
   ...
   - `.ai/do-not-open/tasks/YYYYMMDD-400-402-live-dry-run.md`
   - `.ai/do-not-open/tasks/YYYYMMDD-400-live-dry-run-1.md`
   - `.ai/do-not-open/tasks/YYYYMMDD-401-live-dry-run-2.md`
   - `.ai/do-not-open/tasks/YYYYMMDD-402-live-dry-run-3.md`
