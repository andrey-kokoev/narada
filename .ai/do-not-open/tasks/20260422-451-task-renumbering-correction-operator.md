...
- **Reports**: update task references in `.ai/reports/` or `.ai/do-not-open/tasks/` body links.
...
error: ambiguous: 4 files match Task 3:
  - .ai/do-not-open/tasks/20260410-003-assignment-agent-a-cli-polish.md
  - .ai/do-not-open/tasks/20260410-003-migrate-search-to-fts5.md
  ...
Use --file <path> to specify which one to renumber.

# Task 003 with explicit file selection
$ npx tsx scripts/task-renumber.ts --from 3 --to 500 --file .ai/do-not-open/tasks/20260410-003-migrate-search-to-fts5.md --dry-run
Renumbering Task 3 -> 500
[RENAME] .ai/do-not-open/tasks/20260410-003-migrate-search-to-fts5.md -> .ai/do-not-open/tasks/20260410-500-migrate-search-to-fts5.md
[EDIT]   .ai/do-not-open/tasks/20260410-003-migrate-search-to-fts5.md: Update heading, front matter, and body references; append corrections section
[EDIT]   .ai/do-not-open/tasks/20260410-004-assignment-agent-b-core-infra.md: Update references to Task 3 -> 500
... (10 total patches)
Dry-run mode. No files were modified. Use --execute to apply.

# Task 124 collision
$ npx tsx scripts/task-renumber.ts --from 124 --to 600 --file .ai/do-not-open/tasks/20260418-124-comprehensive-semantic-architecture-audit.md --dry-run
Renumbering Task 124 -> 600
[RENAME] .ai/do-not-open/tasks/20260418-124-comprehensive-semantic-architecture-audit.md -> .ai/do-not-open/tasks/20260418-600-comprehensive-semantic-architecture-audit.md
[EDIT]   .ai/do-not-open/tasks/20260418-124-comprehensive-semantic-architecture-audit.md: Update heading, front matter, and body references; append corrections section
... (18 total patches)
Dry-run mode. No files were modified.

# Task 288 collision
$ npx tsx scripts/task-renumber.ts --from 288 --to 700 --file .ai/do-not-open/tasks/20260420-288-plan.md --dry-run
Renumbering Task 288 -> 700
[RENAME] .ai/do-not-open/tasks/20260420-288-plan.md -> .ai/do-not-open/tasks/20260420-700-plan.md
[EDIT]   .ai/do-not-open/tasks/20260420-288-plan.md: Update heading, front matter, and body references; append corrections section
... (9 total patches)
Dry-run mode. No files were modified.
```
...
```bash
$ echo '---\nstatus: opened\ndepends_on: [443]\n---\n\n# Task 9999 — Test\n\n## Context\nTest.\n\n## Goal\nVerify.\n\n## Acceptance Criteria\n- [ ] Done.\n\n## Related\nSee Task 443.' > .ai/do-not-open/tasks/20260422-9999-test-renumber-target.md

$ npx tsx scripts/task-renumber.ts --from 9999 --to 9998 --execute
Renumbering Task 9999 -> 9998
[RENAME] .ai/do-not-open/tasks/20260422-9999-test-renumber-target.md -> .ai/do-not-open/tasks/20260422-9998-test-renumber-target.md
[EDIT]   .ai/do-not-open/tasks/20260422-9999-test-renumber-target.md: Update heading, front matter, and body references; append corrections section
[WRITTEN] .ai/do-not-open/tasks/20260422-9999-test-renumber-target.md
[RENAMED] .ai/do-not-open/tasks/20260422-9999-test-renumber-target.md -> .ai/do-not-open/tasks/20260422-9998-test-renumber-target.md
...
$ rm .ai/do-not-open/tasks/20260422-9998-test-renumber-target.md
```
