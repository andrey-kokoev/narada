...
- `.ai/do-not-open/tasks/20260423-488-evidence-based-not-complete-task-list.md`
- `.ai/do-not-open/tasks/20260423-489-work-result-report-dedup-and-deterministic-identity.md`
...
### Docs
- Updated `.ai/do-not-open/tasks/tasks/assignments/README.md` with intent semantics, backward compatibility rules, and the intent/reason separation.
