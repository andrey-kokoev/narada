...
1. **Task artifacts left stale**
   - `.ai/do-not-open/tasks/20260419-216-correct-task-208-selector-surface-overclaim-and-partial-consumption.md`
   - `.ai/do-not-open/tasks/20260419-217-correct-task-209-promotion-retry-transition-semantics.md`
   - `.ai/do-not-open/tasks/20260419-221-correct-task-206-projection-rebuild-multi-mailbox-and-task-state.md`
...
- `.ai/do-not-open/tasks/20260419-215-correct-task-204-recovery-vs-replay-and-task-state.md`
...
- `.ai/do-not-open/tasks/20260419-221-correct-task-206-projection-rebuild-multi-mailbox-and-task-state.md`
- `.ai/do-not-open/tasks/20260419-215-correct-task-204-recovery-vs-replay-and-task-state.md`
- `.ai/do-not-open/tasks/20260419-223-correct-task-215-kernel-doc-coherence-for-recovery-surface.md`
- `packages/layers/control-plane/docs/00-kernel.md`
