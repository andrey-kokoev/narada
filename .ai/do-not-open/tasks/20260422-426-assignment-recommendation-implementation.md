...
- `.ai/do-not-open/tasks/*.md` task front matter and dependencies;
- `.ai/agents/roster.json`;
- `.ai/do-not-open/tasks/tasks/assignments/*.json`;
- `.ai/do-not-open/tasks/tasks/reports/*.json` if created by Task 425;
- `.ai/reviews/*.json`;
...
- `.ai/do-not-open/tasks/20260422-426-assignment-recommendation-implementation.md` — this file
...
- Durable recommendation storage in `.ai/do-not-open/tasks/recommendations/` is not implemented (schema is defined but no storage operator exists).
