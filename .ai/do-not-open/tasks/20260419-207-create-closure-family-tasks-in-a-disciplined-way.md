...
- `.ai/do-not-open/tasks/20260419-208-selection-operator-family.md`
- `.ai/do-not-open/tasks/20260419-210-inspection-operator-family-alignment.md`
- `.ai/do-not-open/tasks/20260419-209-promotion-operator-family.md` (produced but requires rewrite; see correction note below)
...
The rewrite was applied directly to `.ai/do-not-open/tasks/20260419-209-promotion-operator-family.md`.
