...
Add a corrective note to `.ai/do-not-open/tasks/20260419-238-draft-disposition-surface.md` referencing this task and the canonical operator path.
...
Added a "Corrective Follow-up" section to `.ai/do-not-open/tasks/20260419-238-draft-disposition-surface.md` referencing Task 267 and documenting the canonical path and payload encoding fix.
