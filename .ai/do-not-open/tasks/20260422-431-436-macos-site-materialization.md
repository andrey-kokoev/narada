...
| File | Task |
|------|------|
| `.ai/do-not-open/tasks/20260422-431-macos-site-boundary-contract.md` | 431 |
| `.ai/do-not-open/tasks/20260422-432-launchd-runner-supervision-spike.md` | 432 |
| `.ai/do-not-open/tasks/20260422-433-macos-credential-path-binding-contract.md` | 433 |
| `.ai/do-not-open/tasks/20260422-434-macos-health-trace-operator-integration.md` | 434 |
| `.ai/do-not-open/tasks/20260422-435-macos-sleep-wake-recovery-fixture.md` | 435 |
| `.ai/do-not-open/tasks/20260422-436-macos-site-materialization-closure.md` | 436 |
