...
rg -n "macOS|launchd|LaunchAgent|Keychain|TCC|sleep|wake|Application Support" docs/deployment/macos-site-materialization.md .ai/do-not-open/tasks/20260422-*.md
