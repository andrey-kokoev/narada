...
- `.ai/tasks/20260418-137-materialize-124-F-align-posture-preset-naming-EXECUTED.md`
...
- [x] `.ai/tasks/20260418-137-materialize-124-F-align-posture-preset-naming-EXECUTED.md` is removed
...
4. **Folded execution evidence back into the canonical Task 137 file**.
   - Updated `.ai/tasks/20260418-137-materialize-124-F-align-posture-preset-naming.md` with an "Execution Evidence" section.
...
- `.ai/tasks/20260418-137-materialize-124-F-align-posture-preset-naming.md` (folded execution evidence)
- `.ai/tasks/20260418-137-materialize-124-F-align-posture-preset-naming-EXECUTED.md` (deleted)
...
- `ls .ai/tasks/*137*` confirms only the canonical task file remains
