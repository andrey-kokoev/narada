...
- `.ai/tasks/20260421-371-377-windows-site-materialization.md`
...
2. Define the chapter DAG.
   ...
   Create `.ai/tasks/20260422-387-392-email-marketing-operation.md` or the smallest correct range.
...
Created `.ai/tasks/20260422-387-394-email-marketing-operation.md` with 8-task DAG:
