...
- `.ai/tasks/20260422-428-macos-site-materialization-chapter.md`.
...
rg -n "Linux|systemd|journald|/var/lib/narada|/etc/narada|XDG|Secret Service|NoNewPrivileges|cron" docs/deployment/linux-site-materialization.md .ai/tasks/20260422-*.md
...
4. **Chapter DAG** — `.ai/tasks/20260422-437-442-linux-site-materialization.md` with tasks 437–442.
