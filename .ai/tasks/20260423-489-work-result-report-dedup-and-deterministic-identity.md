...
6. Update docs.
   - Update `.ai/tasks/reports/README.md` with the single-report-per-assignment invariant.
...
- Historical duplicate reports in `.ai/tasks/reports/` (e.g., the two 485 reports) are not automatically cleaned up. A separate cleanup operator could be added later.
