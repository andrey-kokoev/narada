...
- `SEMANTICS.md`
- `.ai/tasks/20260422-444-task-governance-principal-runtime-bridge-contract.md`
- `.ai/decisions/20260422-444-task-governance-principal-runtime-bridge.md`
- `.ai/tasks/20260422-456-implement-task-governance-principal-runtime-bridge.md`
- `.ai/tasks/20260422-463-task-completion-evidence-and-closure-enforcement.md`
- `.ai/tasks/20260422-454-site-bootstrap-contract-and-cli.md`
- `.ai/tasks/20260422-427-governed-promotion-recommendation-to-assignment.md`
- `.ai/tasks/20260422-425-work-result-report-governance-primitive.md`
- `.ai/tasks/20260422-426-assignment-recommendation-implementation.md`
...
Use the task reservation protocol. If the reservation tool is unavailable, document the fallback and update `.ai/tasks/.registry.json` manually.
...
During file creation, discovered that task numbers 465 and 466 were already reserved in `.ai/tasks/.registry.json` for other tasks. The collision was resolved by:
