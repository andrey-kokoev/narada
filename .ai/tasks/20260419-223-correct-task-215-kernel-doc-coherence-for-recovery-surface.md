...
Update `.ai/tasks/20260419-215-correct-task-204-recovery-vs-replay-and-task-state.md` if needed so its execution notes mention this final doc-alignment correction or explicitly note it as follow-up.
...
2. **`.ai/tasks/20260419-215-correct-task-204-recovery-vs-replay-and-task-state.md`** — Added "Follow-up: Task 223" section referencing the kernel-doc alignment
