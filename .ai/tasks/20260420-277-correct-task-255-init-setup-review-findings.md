...
Update `.ai/tasks/20260420-255-init-setup-path-hardening.md` so verification evidence is categorized honestly:
...
Updated `.ai/tasks/20260420-255-init-setup-path-hardening.md`:
