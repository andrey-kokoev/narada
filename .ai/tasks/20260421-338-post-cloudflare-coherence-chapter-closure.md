...
- `.ai/tasks/20260421-334-control-cycle-fixture-discipline.md`
- `.ai/tasks/20260421-335-runtime-locus-abstraction.md`
- `.ai/tasks/20260421-336-unattended-operation-layer.md`
- `.ai/tasks/20260421-337-mailbox-daily-use-closure.md`
...
```bash
rg -n "status: (opened|closed|deferred)|depends_on:" .ai/tasks/20260421-33*.md
