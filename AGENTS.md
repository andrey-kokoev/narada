...
| [dharma-observer-role.md](docs/concepts/dharma-observer-role.md) | Dharma Observer Role — read-only observer of Narada law, telos, authority boundaries, and inhabited-evolution discipline | Need to bootstrap or constrain a non-builder, non-reviewer observer thread |
