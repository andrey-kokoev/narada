...
function runJson(entrypoint: any, extraArgs: any= [], siteRoot: any= naradaRoot, identity: any= 'narada.architect') {
...
function writeJson(path: any, value: any) {
  writeFileSync(path, `${JSON.stringify(value, null, 2)}\n`, 'utf8');
}

function createTemporarySiteWithMcpServer(serverName: any) {
...
function assertModernAgentCliLaunch(result: any) {
