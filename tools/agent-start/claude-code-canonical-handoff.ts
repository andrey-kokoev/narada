...
const CANONICAL_SURFACES: Record<string, any> = {
  task: {
...
function runNaradaCommand(command: any, { cwd }: any) {
...
function canonicalRequestFromDecision(decision: any, { sourceEvidencePath = null }: any= {}) {
...
function writeCanonicalHandoff(siteRoot: any, handoff: any, requestPath: any= null) {
...
function writeCanonicalRequest(siteRoot: any, handoff: any) {
...
function createCanonicalHandoff(siteRoot: any, decision: any, options: any= {}) {
