...
function objectShape(value: any) {
...
function summarizeProposedActionPacket(packet: any) {
  if (!packet) {
    return null;
  }
  return {
...
function sanitizeAdapterOutput(output: any) {
  return {
...
function fixtureAdapter(input: any) {
  return {
...
function invokeAdapter({ siteRoot, carrierSessionId, adapter = fixtureAdapter, input, now = new Date().toISOString() }: any) {
