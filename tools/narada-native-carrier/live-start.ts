...
import { resolveProviderCapabilityProjection } from './capability-projection.ts';
import { buildFixtureRuntimeHandle, buildMissingRuntimeHandle, validateRuntimeHandle } from './runtime-handle.ts';
...
function blockedReasonForCapability(reason: any) {
...
function boundedRegistrationReadiness(readiness: any) {
  return {
