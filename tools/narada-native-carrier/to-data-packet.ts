...
export function buildToDataPacketFixture(readFamily: any, overrides: any= {}) {
...
export function validateToDataPacket(packet: any) {
  const errors = [];
...
function sourceSurfaceFor(readFamily: any) {
  switch (readFamily) {
    case 'task_packet':
...
function boundedSummaryFor(readFamily: any) {
  return {
