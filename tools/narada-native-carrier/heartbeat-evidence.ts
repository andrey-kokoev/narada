...
import { buildMissingRuntimeHandle, validateRuntimeHandle } from './runtime-handle.ts';
...
function runtimeHeartbeatPosture(runtimeHandle: any, now: any) {
...
function boundedWorkSummary(summary: any) {
...
function boundedReachability(reachability: any) {
