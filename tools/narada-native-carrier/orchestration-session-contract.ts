...
export function buildOrchestrationResultFixture(mode: any, overrides: any= {}) {
...
export function validateOrchestrationInput(input: any) {
  const errors = [];
...
export function validateOrchestrationResult(result: any) {
  const errors = [];
